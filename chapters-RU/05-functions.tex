...
\textbf{Сравнение термов} возвращает \emph{булево} (логическое) значение, в форме
...
Квалификаторы вычисляются слева направо, генераторы создают значения и фильтры 
